...
public class Player extends Character {
    ...
    public void turn(Game game, Character target) {
        while (true) {  // Loop until the player actually uses a move or the turn ends
            ...
            String[] options = new String[moveset.size() + 2];  // +2 for View Stats and (optionally) other actions
            ...
            options[moveset.size() + 1] = "End Turn";   // Optional: allow skipping turn
            ...
            if (choice == moveset.size()) {
                ...
                JOptionPane.showMessageDialog(null, statsMessage, "Player Stats - " + name, JOptionPane.INFORMATION_MESSAGE);
                continue;  
            }
